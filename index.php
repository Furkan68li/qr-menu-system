...
// Restoran Bilgileri (Gelecekte veritabanından çekilebilir)
$restaurant_info = [
    'name' => 'QR Lezzet Durağı',
...
<body class="selection:bg-brand-primary selection:text-white pb-20">
    ...
    <!-- Sidebar Overlay -->
    <div id="sidebarOverlay" class="fixed inset-0 bg-black/80 z-[60] hidden transition-opacity duration-300 opacity-0 backdrop-blur-sm"></div>

    <!-- Sidebar -->
    <aside id="sidebar" class="fixed top-0 left-0 h-full w-[85%] max-w-sm bg-[#111] z-[70] transform -translate-x-full transition-transform duration-300 ease-out border-r border-white/10 shadow-2xl overflow-y-auto">
        <div class="p-6 relative">
            <!-- Close Button -->
            <button id="closeSidebar" class="absolute top-6 right-6 p-2 text-gray-400 hover:text-white bg-white/5 rounded-full">
            ...
            <div class="mb-10 mt-2">
                <div class="w-16 h-16 bg-gradient-to-tr from-brand-primary to-brand-secondary rounded-2xl flex items-center justify-center mb-4 shadow-lg shadow-brand-primary/20">
            ...
            <div class="space-y-8">
                ...
                <div class="flex gap-4">
                    <div class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center shrink-0 text-brand-secondary">
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <a href="<?= $restaurant_info['maps_link'] ?>" target="_blank" class="inline-flex items-center text-xs font-bold text-brand-primary hover:text-brand-secondary">
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <a href="tel:<?= $restaurant_info['phone'] ?>" class="inline-flex items-center px-3 py-1.5 rounded-lg bg-white/10 text-xs font-bold text-white hover:bg-brand-primary hover:text-black transition-colors">
                            <?= $t['call_now'] ?>
                        </a>
                    </div>
                </div>
    ...
    <header class="pt-8 pb-6 px-6 text-center relative">
        <!-- Sidebar Toggle -->
        <button id="openSidebar" class="absolute top-6 left-6 p-2 bg-white/5 border border-white/10 rounded-full text-white hover:bg-white/10 active:scale-95 transition-all z-20">
        ...
        <h1 class="text-4xl font-display font-bold text-white mb-2"><?= $t['title'] ?></h1>
        <p class="text-brand-muted text-sm mb-6"><?= $t['slogan'] ?></p>
